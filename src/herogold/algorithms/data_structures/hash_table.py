...
class HashTable[K, V]:
    ...
    def __init__(self, size: int = 11) -> None:
        ...
        self.size = size
        self._len = 0
        self._keys: list[K | object] = [self._empty] * size
        self._values: list[V | object] = [self._empty] * size
    ...
    def put(self, key: K, value: V) -> None:
        ...
        """
        initial_hash = hash_ = self.hash(key)  # type: ignore[arg-type]
    ...
    def get(self, key: K) -> V | None:
        ...
        while True:
            if self._keys[hash_] is self._empty:
                return None
            if self._keys[hash_] == key:
                return self._values[hash_]  # type: ignore[return-value]
